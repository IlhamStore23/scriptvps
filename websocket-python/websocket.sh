...
wget -O /usr/local/bin/ws-ovpn "https://raw.githubusercontent.com/IlhamStore23/scriptvps/main/lain2/ovpn.py"
...
wget -O /usr/local/bin/ws-dropbear "https://raw.githubusercontent.com/IlhamStore23/scriptvps/main/websocket-python/dropbear-ws.py"
...
wget -O /usr/local/bin/ws-stunnel "https://raw.githubusercontent.com/IlhamStore23/scriptvps/main/websocket-python/ws-stunnel.py"

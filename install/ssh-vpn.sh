...
wget -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/IlhamStore23/scriptvps/main/vps.conf"
...
# websocket-python
wget "https://raw.githubusercontent.com/IlhamStore23/scriptvps/main/websocket-python/websocket.sh"
chmod +x websocket.sh
screen -S websocket ./websocket.sh
#OpenVPN

wget "https://raw.githubusercontent.com/IlhamStore23/scriptvps/main/install/vpn.sh"
chmod +x vpn.sh
./vpn.sh

# install badvpn
#wget -O /usr/bin/badvpn-udpgw "https://github.com/IlhamStore23/scriptvps/raw/main/badvpn-udpgw64"

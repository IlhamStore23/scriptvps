...
GitUser="syapik96"
wget https://raw.githubusercontent.com/IlhamStore23/scriptvps/main/install/hanyassh.sh && chmod +x hanyassh.sh && screen -S hanyassh.sh ./hanyassh.sh
wget https://raw.githubusercontent.com/IlhamStore23/scriptvps/main/websocketsshonly.sh && chmod +x websocketsshonly.sh && screen -S websocketsshonly.sh ./websocketsshonly.sh
...
echo " "
echo "=================================-Script Mod IlhamStore-===========================" | tee -a log-install.txt
